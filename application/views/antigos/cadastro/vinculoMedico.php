...
$(document).ready(function(){
   $('#especialidade').SumoSelect({placeholder: 'Selecione a(s) especialidade(s)'}); 
});
</script>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            $readonly="readonly";
             ...
             <br>
            <label class="col-md-3 control-label" for="crm">Email</label>  
            <div class="col-md-9">
                <input id="codigo" name="email" type="text" value="<?=$medico['EMAIL']?>" <?= $readonly; ?> class="form-control input-md" required="" >
            </div>
                    ...
                    <div class="col-md-9">
                       <select  id="especialidade" name="especialidade[]" class="form-control" multiple="" >
                            <?php foreach ($especialidades as $especialidade) {
                                    $selected="";
                                    foreach ($especialidadesMedico as $especialidadeMedico) {
                                        
                                        if($especialidade['CODIGO'] == $especialidadeMedico['CODIGO']){
                                ...
                                <option  value=<?=$especialidade['CODIGO'] ?>  <?= $selected?> ><?=$especialidade['ESPECIALIDADE'] ?></option>
                            <?php }?>
        ...
        <div class="agenda">
            ...
            <div class="tab-content"> 
                ...
                <div class="tab-pane active alert alert-warning form-group" id="domingo">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="de_dom" id="de_dom" min="0" max="24" value="<?php if(isset($de_dom)){echo $de_dom;} ?>"  class="form-control ">
                    </div>
                    <br class="clearfix">
                    <label for="ate_dom" class="col-sm-2 control-label"><strong> até </strong></label>
                    <div class="col-sm-9">
                        <input type="number" name="ate_dom" id="ate_dom" min="0" max="24" value="<?php if(isset($ate_dom)){echo $ate_dom;} ?>" class="form-control ">
                    </div>
                </div>
                ...
                <div class="tab-pane alert alert-warning form-group" id="segunda">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="de_seg" id="de_dom" min="0" max="24" value="<?php if(isset($de_seg)){echo $de_seg;} ?>" class="form-control ">
                    </div>
                    <br class="clearfix">
                    <label for="ate_seg" class="col-sm-2 control-label"><strong> até </strong></label>
                    <div class="col-sm-9">
                        <input type="number" name="ate_seg" id="ate_dom" min="0" max="24" value="<?php if(isset($ate_seg)){echo $ate_seg;} ?>" class="form-control ">
                    </div>
                </div>
                ...
                <div class="tab-pane alert alert-warning form-group" id="terca">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="de_ter" id="de_dom" min="0" max="24" value="<?php if(isset($de_ter)){echo $de_ter;} ?>" class="form-control ">
                    </div>
                    <br class="clearfix">
                    <label for="ate_ter" class="col-sm-2 control-label"><strong> até </strong></label>
                    <div class="col-sm-9">
                        <input type="number" name="ate_ter" id="ate_dom" min="0" max="24" value="<?php if(isset($ate_ter)){echo $ate_ter;} ?>" class="form-control ">
                    </div>
                </div>
                ...
                <div class="tab-pane alert alert-warning form-group" id="quarta">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="de_qua" id="de_dom" min="0" max="24" value="<?php if(isset($de_qua)){echo $de_qua;} ?>" class="form-control ">
                    </div>
                    <br class="clearfix">
                    <label for="ate_qua" class="col-sm-2 control-label"><strong> até </strong></label>
                    <div class="col-sm-9">
                        <input type="number" name="ate_qua" id="ate_dom" min="0" max="24" value="<?php if(isset($ate_qua)){echo $ate_qua;} ?>" class="form-control "> 
                    </div>
                </div>
                ...
                <div class="tab-pane alert alert-warning form-group" id="quinta">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="de_qui" id="de_dom" min="0" max="24" value="<?php if(isset($de_qui)){echo $de_qui;} ?>" class="form-control ">
                    </div>
                    <br class="clearfix">
                    <label for="ate_qui" class="col-sm-2 control-label"><strong> até </strong></label>
                    <div class="col-sm-9">
                        <input type="number" name="ate_qui" id="ate_dom" min="0" max="24" value="<?php if(isset($ate_qui)){echo $ate_qui;} ?>" class="form-control ">
                    </div>
                </div>
                ...
                <div class="tab-pane alert alert-warning form-group" id="sexta">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="de_sex" id="de_dom" min="0" max="24" value="<?php if(isset($de_sex)){echo $de_sex;} ?>" class="form-control ">
                    </div>
                    <br class="clearfix">
                    <label for="ate_sex" class="col-sm-2 control-label"><strong> até </strong></label>
                    <div class="col-sm-9">
                        <input type="number" name="ate_sex" id="ate_dom" min="0" max="24"  value="<?php if(isset($ate_sex)){echo $ate_sex;} ?>" class="form-control ">
                    </div>
                </div>
                ...
                <div class="tab-pane alert alert-warning form-group" id="sabado">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="de_sab" id="de_dom" min="0" max="24" value="<?php if(isset($de_sab)){echo $de_sab;} ?>" class="form-control ">
                    </div>
                    <br class="clearfix">
                    <label for="ate_sab" class="col-sm-2 control-label"><strong> até </strong></label>
                    <div class="col-sm-9">
                        <input type="number" name="ate_sab" id="ate_dom" min="0" max="24" value="<?php if(isset($ate_sab)){echo $ate_sab;} ?>" class="form-control ">
                    </div>
                </div>
                
            </div>
            <div class="alert alert-warning"><strong>Aviso: </strong>Sempre que o horario final for "0" selecione "24" <br>Ex: de 16 até 24 <br> forma errada: <strike>de 16 até 0</strike></div>
        </div>
    </div>
