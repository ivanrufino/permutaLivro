...
<HTML>
    <HEAD>
        ...
        <meta name="Generator" content="boleto siscore sistema receituario controle" />
        <style type=text/css>
    ...
    <body text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
                ...
                <td valign=top class=cp>
                    <div ALIGN="left">
                        ...
                        <li>Caso tenha problemas ao imprimir, copie a sequencia numérica abaixo e pague no caixa eletrônico ou no internet banking:<br><br>
                            ...
                            <span class="ld2">
                                &nbsp;&nbsp;&nbsp;&nbsp;Linha Digitável: &nbsp;<?php echo $linhaDigitavel ?><br>
            ...
            <tbody>
                <tr>
                    <td class=ct width=666>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/6.png width=665 border=0>
                    </td>
                </tr>
                <tr>
                    <td class=ct width=666>
        ...
        <table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
            <tr>
                <td width=41>
                    <img src="<?= base_url() ?>assets/imagens/logo.png" height="60">
                </td>
                <td class=ti width=455>
                    <?php echo $identificacao; ?> <?php echo isset($cpf_cnpj) ? "<br>" . $cpf_cnpj : '' ?>
                    <br>
                    <?php echo $endereco; ?>
                    <br>
                    <?php echo $cidade_uf; ?>
        ...
        <table cellspacing=0 cellpadding=0 width=666 border=0>
            <tr>
                <td class=cp width=150> 
                    <span class="campo">
                        <img src="<?= base_url() ?>assets/imagens/boleto/imagens/logobradesco.jpg" width="150" height="40" border=0>
                    </span>
                </td>
                <td width=3 valign=bottom>
                    <img height=22 src=<?= base_url() ?>assets/imagens/boleto/imagens/3.png width=2 border=0>
                </td>
            ...
            <tbody>
                <tr>
                    <td colspan=5>
                        <img height=2 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=666 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td class=ct valign=top width=7 height=13>
                        <img height=13 src=<?= base_url() ?>assets/imagens/boleto/imagens/1.png width=1 border=0>
                    </td>
                    ...
                    <td class=ct valign=top width=7 height=13>
                        <img height=13 src=<?= base_url() ?>assets/imagens/boleto/imagens/1.png width=1 border=0></td>
                    <td class=ct valign=top width=120 height=13>Nosso número</td>
                </tr>
                <tr>
                    <td class=cp valign=top width=7 height=12>
                        <img height=12 src=<?= base_url() ?>assets/imagens/boleto/imagens/1.png width=1 border=0>
                    </td>
                ...
                <tr>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=298 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=298 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=126 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=126 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=34 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=34 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=53 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=53 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=120 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=120 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign=top width=113 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=113 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=72 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=72 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=132 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=132 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=134 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=134 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=180 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=180 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
        <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
                <tr>
                    ...
                    <td class=ct valign=top width=112 height=13>(-) Outras deduçoes</td>
                    <td class=ct valign=top width=7 height=13>
                        <img height=13 src=<?= base_url() ?>assets/imagens/boleto/imagens/1.png width=1 border=0>
                    </td>
                ...
                <tr>
                    ...
                    <td valign=top width=112 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=112 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign=top width=659 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=659 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class=cp width=564 >
                        <span class="campo">
                            <?php
                            foreach ($demonstrativo as $valor) {
                                echo $valor . "<br>";
                            }
                            ?>
                            <br>                            
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign=top width=472 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=472 border=0>
                    </td>
                    <td valign=top width=7 height=1><img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=180 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=180 border=0>
                    </td>
        ...
        <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
                <tr>
                    ...
                    <td class=ct valign=top width=153 height=13>No documento</td>
                    <td class=ct valign=top width=7 height=13> 
                        <img height=13 src=<?= base_url() ?>assets/imagens/boleto/imagens/1.png width=1 border=0>
                    </td>
                ...
                <tr>
                    ...
                    <td valign=top width=153 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=153 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=62 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=62 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    ...
                    <td valign=top width=82 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=82 border=0>
                    </td>
                    <td valign=top width=7 height=1> 
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
            ...
            <tbody>
                <tr> 
                    ...
                    <td class=ct valign=top width=72 height=13> 
                        Valor Documento</td><td class=ct valign=top width=7 height=13>
                        <img height=13 src=<?= base_url() ?>assets/imagens/boleto/imagens/1.png width=1 border=0>
                    </td>
                    <td class=ct valign=top width=180 height=13>(=)Valor documento</td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=75 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=31 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=31 border=0>
                    </td>
                    <td valign=top width=7 height=1> 
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    <td valign=top width=83 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=83 border=0>
                    </td>
                    <td valign=top width=7 height=1> 
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    ...
                    <td valign=top width=123 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=123 border=0>
                    </td>
                    <td valign=top width=7 height=1> 
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=7 border=0>
                    </td>
                    ...
                    <td align=right width=10>
                        <table cellspacing=0 cellpadding=0 border=0 align=left>
                            <tbody> 
                                ...
                                <tr>
                                    <td valign=top width=7 height=1>
                                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=1 border=0>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                                <tr>
                                    ...
                                    <td class=ct valign=top width=180 height=13>(-)Outras deduçoes</td>
                                </tr>
                                <tr>
                                    <td class=cp valign=top width=7 height=12>
                                        <img height=12 src=<?= base_url() ?>assets/imagens/boleto/imagens/1.png width=1 border=0>
                    ...
                    <td align=right width=188>
                        <table cellspacing=0 cellpadding=0 border=0>
                            <tbody>
                                ...
                                <tr>
                                    <td class=cp valign=top width=7 height=12>
                                        <img height=12 src=<?= base_url() ?>assets/imagens/boleto/imagens/1.png width=1 border=0></td>
                                    <td class=cp valign=top align=right width=180 height=12></td>
                                </tr>
                            </tbody>
                        </table>                            
            ...
            <tbody>
                <tr>
                    <td valign=top width=666 height=1>
                        <img height=1 src=<?= base_url() ?>assets/imagens/boleto/imagens/2.png width=666 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
...
<?php echo $endereco2 ?>
            ...
            <tbody>
                <tr>
                    ...
                    <td class=ct  width=250 >
                        <div align=right>
                            Autenticaçao mecânica - <b class=cp> Ficha de Compensação</b>
                        </div>
                    </td>
                </tr>
                <tr>
        ...
        <table cellSpacing=0 cellPadding=0 width=666 border=0>
            <tbody>
                <tr>
                    <td vAlign=bottom align=left height=50 style="font-size: 0px"><?= $barra ?> 
                    </td>
                </tr>
            </tbody>
        </table>
