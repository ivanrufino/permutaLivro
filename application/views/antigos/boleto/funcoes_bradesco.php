...
//agencia � 4 digitos
$agencia = formata_numero($agencia,4,0);
//conta � 6 digitos
$conta = formata_numero($conta,6,0);
//dv da conta
$conta_dv = formata_numero($conta_dv,1,0);
...
$conta_cedente = formata_numero($conta_cedente,7,0);
//dv da conta cedente
...
$agencia_codigo = $agencia."-".$agencia_dv." / ". $conta_cedente ."-". $conta_cedente_dv;
...
//Guarda inicial
?>
<img src=<?=base_url() ?>assets/imagens/boleto/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0>
<img src=<?=base_url() ?>assets/imagens/boleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0>
<img src=<?=base_url() ?>assets/imagens/boleto/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0>
<img src=<?=base_url() ?>assets/imagens/boleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0>
<img 
    <?php
...
?>
    src=<?=base_url() ?>assets/imagens/boleto/imagens/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=<?=base_url() ?>assets/imagens/boleto/imagens/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=<?=base_url() ?>assets/imagens/boleto/imagens/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=<?=base_url() ?>assets/imagens/boleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?=base_url() ?>assets/imagens/boleto/imagens/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da fun��o
