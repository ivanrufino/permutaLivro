 ...
 <input type="hidden" id="msgmedicos" value="atendente">
        ...
        <div class="table-responsive">
            <table id="mytable" class="table table-bordred table-striped">
                <div class="col-md-8"><a href='{base_url}admin/cadastroAtendente' class='btn btn-success  pull-right '> <span class="glyphicon glyphicon-plus">    </span> Adicionar Atendente</a>   </div>
